...
| **Client extensions** | Per-host adapters — subagents, slash commands, host manifests | `agents/`, `commands/`, `.claude-plugin/`, `.codex-plugin/`, `.cursor-plugin/`, `.plugin/` | per host |
...
├── spec/                              ← offline mirrors: agent-skills-spec.md, design-md-spec.md
