...
2. **Load the consumption canon.** Read in this order:
   ...
   - `$HOME/.agents/skills/design-engineering/references/meta/using-design-md.md` — how this skill recommends consuming one. Tokens are normative; prose is context.
   - `$HOME/.agents/skills/design-engineering/references/meta/pov.md` — installer overrides may take precedence over the project's DESIGN.md in personal projects.
