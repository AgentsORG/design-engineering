...
If those three pass, add the file under `agents/`, link it from [[SKILL]] under "Workflow subagents," update this README, and bump the skill version.
